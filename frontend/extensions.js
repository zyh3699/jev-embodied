...
export async function createExtensions(
  ...
  container.innerHTML = `<div class="extension-heading"><div><p class="eyebrow">CONFIGURATION / RESOURCES</p><h1>实验配置</h1><p>管理模型连接与可复用场景。输入探针保留为独立调试工具。</p></div><label>应用到<select id="ext-target"><option value="workbench">当前实验</option><option value="comparison">模型对比</option></select></label></div>
  <details class="extension-section" id="ext-models" open><summary><b>模型配置</b><span>连接与凭据</span></summary><div class="extension-body"><div class="extension-actions"><button class="secondary" id="ext-new-profile">新建模型配置</button></div><div id="ext-profile-list" class="extension-profile-list"></div><p class="extension-hint" id="ext-profile-storage"></p></div></details>
